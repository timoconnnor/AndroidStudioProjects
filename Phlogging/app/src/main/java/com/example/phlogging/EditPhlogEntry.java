...
public class EditPhlogEntry extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_phlog);
        ...
        switch (view.getId()) {
            case R.id.edit_take_photo_button:
                ...
                Uri photoUri = FileProvider.getUriForFile(
                        ...
                        new File(cameraFileName)
                );

                // Grant permission to the camera app to write to the file
            ...
            case R.id.edit_update_location_button:
                // Updates the location using SensorLocatorDecoder
            ...
            case R.id.edit_save_button:
                ...
                // Check if currentLocation is not null before accessing its properties
